            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <img alt="image" src="{{asset($dataAccount->photo ? 'images/' . $dataAccount->photo : 'https://placehold.co/150x150')}}" class="rounded-circle "  style="width: 50px; height: 50px; object-fit: cover;">
